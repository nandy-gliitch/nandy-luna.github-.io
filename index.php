...
<html lang="en">
	<head>
	    ...
	    <title>easy buy shop Home Page</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over Rwf. 600.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="product-price">	
				<span class="price">
					Rwf.<?php echo htmlentities($row['productPrice']);?>			</span>
										     <span class="price-before-discount">Rw.<?php echo htmlentities($row['productPriceBeforeDiscount']);?>	</span>
